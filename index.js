...
class EQ3Thermostat {
  constructor(log, config) {
    ...
    setInterval(() => {
      this.updateCache();
    }, 300 * 1000); // Default cache duration of 5 minutes
  }
  ...
  isCacheValid() {
    return (Date.now() - this.lastUpdated) <= 300 * 1000; // Default cache duration of 5 minutes
  }
  ...
  getServices() {
    ...
    informationService
      ...
      .setCharacteristic(Characteristic.FirmwareRevision, `300 seconds`); // Default cache duration
